...
app.controller('listaMedicosController', function ($scope, $rootScope, $stateParams, $state, medicoService, modalService) {
    ...
    $scope.refreshGrid = function () {
        ...
        medicoService.get(listMedicosArgs, function (data) {
            $scope.medicos = data;
        });
    };
    ...
    $scope.updateRow = function(row){
      ...
      $state.go("modificarMedicos", {idMedico: idP});
    };
    ...
    $scope.$on('deleteMedico', function (event, id) {
      ...
      medicoService.delete({id: id}).$promise.then(
          function () {
