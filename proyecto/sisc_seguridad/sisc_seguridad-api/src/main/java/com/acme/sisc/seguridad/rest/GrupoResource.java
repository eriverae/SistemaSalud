 ...
 * operaciones que se realizan los perfiles
 *
 * @author Julio
 * @version 1.0
 * @since 2016-05-22
...
public class GrupoResource {
    ...
    /**
     * Metodo listGrupos, retorna un PaginatedListWrapper de los perfiles a
     * asociar al usuario
     *
    ...
    /**
     * Metodo findGrupos, arma y devuelve el PaginatedListWrapper implementando
    ...
    /**
     * Metodo consultarGrupo, devuelve un objeto de tipo GrupoCompleto que trae
     * desde el facade con un id
     *
     * @param id es el identificador del objeto al que se quiere consultar
     * @return retorna GrupoCompleto dto, el el objeto de perfiles y accesos del
     * usuario
     */
    @GET
    @Path("{grupGrup}")
    @Produces(MediaType.APPLICATION_JSON)
    public GrupoCompleto consultarGrupo(@PathParam("grupGrup") Long id) throws CustomException, CustomRunTimeException {
        try {
    ...
    /**
     * Metodo eliminarGrupo, elimina el objeto de tipo Grupo con el id en
     * referencia
     *
    ...
    @DELETE
    @Path("{grupGrup}")
    public void eliminarGrupo(@PathParam("grupGrup") Long id)throws CustomException, CustomRunTimeException {
        try {
    ...
    /**
     * Metodo guardarAcceso, crea y modifica el objeto de tipo Grupo del objeto
     * en referencia
     *
     * @param grupo es el objeto a crear o modificar que llega, si este objeto
     * en su parte id es nulo se crea, sino se modifica
     */
    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    public Grupo guardarAcceso(Grupo grupo) throws CustomException, CustomRunTimeException {
        try {
